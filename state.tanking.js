 var stateTanking = {
    ...
    /** @param {Creep} creep **/
    run: function(creep) {
        var squad = _.filter(Game.creeps,(c)=>(c.memory.defaultState == "healing" || c.memory.defaultState == "tanking")&& creep.pos.inRangeTo(c,2))
        ...
        else if(creep.memory.tankTarget)
        {
            ...
            {
                if(!creep.pos.inRangeTo(target,24) && creep.hits == creep.hitsMax) {
